...
globals
	...
	constant string VERSION = "1.6.67"
endglobals
		...
		loop
			...
			if saveFlag[i - 1] == false then
				...
				if tiaoZhanIndex == 3 then
					...
					if endless_count > decryptInt(DzAPI_Map_GetStoredString(Player(i - 1), "endless"), Player(i - 1)) then
...
globals
	...
	real curMaxDamage = 0 // 当局最高伤害
	integer damage_jf = 0 //  所有人极限伤害奖励积分
endglobals
// 伤害超过一定位数加积分
